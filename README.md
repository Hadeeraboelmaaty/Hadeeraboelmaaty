...
- 🎨 Passionate about creating clean, responsive & user‑friendly interfaces.
- 🧠 Always learning and exploring modern web technologies.
- 📚 Computer Science teacher with strong web development background.
- 🇦🇪 Actively preparing for work opportunities in the UAE.
- 🎥 Planning to create a **YouTube channel** and **Zoom programming classes** for kids (ages 7–14).
...
![Tailwind](https://img.shields.io/badge/TailwindCSS-0ea5e9?style=flat&logo=tailwindcss&logoColor=white)
